...
struct Pt {
    ...
    template<typename T> Pt<N>& init(T p0, T p1, T p2, T p3, T p4, T p5, T p6, T p7) { p[0]=p0; p[1]=p1; p[2]=p2; p[3]=p3; p[4]=p4; p[5]=p5; p[6]=p6; p[7]=p7; return *this;}
...
typedef tr1::shared_ptr<Model> SP_Model;
...
struct Image {
    ...
    Pt<8> intrinsicNonlinearCalibration;
    Pose cameraPose;

    TransformMatrix TM;
};
typedef tr1::shared_ptr<Image> SP_Image;
...
typedef tr1::shared_ptr<Object> SP_Object;
